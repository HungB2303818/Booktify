      ...
      <section class="grid md:grid-cols-2 gap-12">
        <div>
          ...
          <p class="mt-3 text-gray-700 leading-relaxed">
            ...
            thận, đảm bảo mỗi cuốn sách đều mang lại giá trị thật sự. Nền tảng
            thân thiện với người dùng được thiết kế để mang lại trải nghiệm mượn
            sách trực quan, dễ sử dụng,
          </p>

          <h3 class="text-2xl font-bold text-gray-900 mt-10">
            Câu chuyện của chúng tôi
          </h3>
          <p class="mt-3 text-gray-700 leading-relaxed">
            Khởi nguồn từ niềm đam mê đọc sách và mong muốn giúp mọi người tiếp
            cận với những cuốn sách hay một cách dễ dàng hơn, Booktify được sáng
            lập bởi một nhóm độc giả nhiệt huyết và những người yêu công nghệ.
            Chúng tôi nhìn thấy cơ hội sử dụng công nghệ để kết nối mọi người
            với những câu chuyện và ý tưởng có thể truyền cảm hứng, giáo dục và
            mang lại niềm vui.
          </p>
        </div>
